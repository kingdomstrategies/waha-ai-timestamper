    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      {[
        [
          ...
          <TbCircleNumber1 key="1" className="size-8 text-p1 mb-2" />,
        ...
        [
          ...
          <TbCircleNumber2 key="2" className="size-8 text-p1 mb-2" />,
        ],
        [
          'Timestamp!',
          'Using AI, the app will timestamp the text based on its corresponding section in the audio.',
          <TbCircleNumber3 key="3" className="size-8 text-p1 mb-2" />,
        ...
        [
          ...
          <TbCircleNumber4 key="4" className="size-8 text-p1 mb-2" />,
        ],
